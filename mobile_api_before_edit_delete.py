...
<p class="info">
Daily attendance kosam camera start chesi
student face ni camera mundu pettandi.
</p>
...
<p class="info">
Kotha student vachinappudu matrame student ni register cheyyandi.
Existing students kosam every time add cheyyalsina avasaram ledu.
</p>
...
<p class="info">
Attendance records and today's attendance view cheyyandi.
</p>
...
<p class="info">
All attendance records CSV file ga download cheyyandi.
</p>
...
function captureFace() {
    ...
    document.getElementById(
        ...
        "✅ Face photo captured. Save Student click cheyyandi.";
...
def delete_student(student_id):
    ...
    try:
        ...
        print(
            f"Student deleted successfully: {student_name}"
        )
...
<div class="card" id="student-{{ student[0] }}">
...
<div class="info">
Email: {{ student[3] if student[3] else "Not provided" }}
</div>


<button
class="delete-button"
onclick="deleteStudent({{ student[0] }}, {{ student[1]|tojson }})">
...
async function deleteStudent(studentId, studentName) {
    ...
    const confirmed =
        confirm(
            ...
            studentName +
            "?\\n\\n" +
            "Student details, attendance records and face data will be deleted."
        );
